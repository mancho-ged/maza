  ...
  return (
    <div className="container floor-plan-container">
      ...
      >
        ...
        <g id="bina1">
          <polygon
            class="st0"
            points="76.79,175.71 72.29,213 4.14,215.57 18.93,110.14 30.5,110.14 33.07,96 50.43,96 62.64,30.43 
    ...
    178.36,25.29 167.43,110.79 187.36,111.43 	"
        ...
        <g id="bina16">
          <polygon
            class="st0"
            points="42.07,338 35,331.29 35,313.93 22.14,302.36 27.93,254.14 16.36,254.14 9.29,248.36 12.5,224.57 
